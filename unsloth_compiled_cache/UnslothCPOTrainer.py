...
from trl.trainer.cpo_trainer import Any
from trl.trainer.cpo_trainer import AutoModelForCausalLM
from trl.trainer.cpo_trainer import Callable
from trl.trainer.cpo_trainer import CPOConfig
from trl.trainer.cpo_trainer import CPOTrainer
from trl.trainer.cpo_trainer import DataCollator
from trl.trainer.cpo_trainer import DataLoader
from trl.trainer.cpo_trainer import Dataset
from trl.trainer.cpo_trainer import defaultdict
from trl.trainer.cpo_trainer import Dict
from trl.trainer.cpo_trainer import disable_dropout_in_model
from trl.trainer.cpo_trainer import DPODataCollatorWithPadding
from trl.trainer.cpo_trainer import EvalLoopOutput
from trl.trainer.cpo_trainer import F
from trl.trainer.cpo_trainer import inspect
from trl.trainer.cpo_trainer import is_peft_available
from trl.trainer.cpo_trainer import is_torch_fx_proxy
from trl.trainer.cpo_trainer import is_wandb_available
from trl.trainer.cpo_trainer import List
from trl.trainer.cpo_trainer import Literal
from trl.trainer.cpo_trainer import nn
from trl.trainer.cpo_trainer import np
from trl.trainer.cpo_trainer import nullcontext
from trl.trainer.cpo_trainer import Optional
from trl.trainer.cpo_trainer import pad_to_length
from trl.trainer.cpo_trainer import PartialState
from trl.trainer.cpo_trainer import peft_module_casting_to_bf16
from trl.trainer.cpo_trainer import PeftModel
from trl.trainer.cpo_trainer import prepare_model_for_kbit_training
from trl.trainer.cpo_trainer import PreTrainedModel
from trl.trainer.cpo_trainer import PreTrainedTokenizerBase
from trl.trainer.cpo_trainer import random
from trl.trainer.cpo_trainer import torch
from trl.trainer.cpo_trainer import Trainer
from trl.trainer.cpo_trainer import TrainerCallback
from trl.trainer.cpo_trainer import trl_sanitze_kwargs_for_tagging
from trl.trainer.cpo_trainer import Tuple
from trl.trainer.cpo_trainer import Union
from trl.trainer.cpo_trainer import wandb
from trl.trainer.cpo_trainer import warnings
from trl.trainer.cpo_trainer import wraps
...
class _UnslothCPOTrainer(Trainer):
    ...
    def __init__(
        ...
        if tokenizer is None:
            raise ValueError(
                'tokenizer must be specified to tokenize a CPO dataset.',
            )
