...
from trl.trainer.reward_trainer import Any
from trl.trainer.reward_trainer import Callable
from trl.trainer.reward_trainer import compute_accuracy
from trl.trainer.reward_trainer import DataCollator
from trl.trainer.reward_trainer import Dataset
from trl.trainer.reward_trainer import Dict
from trl.trainer.reward_trainer import EvalPrediction
from trl.trainer.reward_trainer import FrozenInstanceError
from trl.trainer.reward_trainer import inspect
from trl.trainer.reward_trainer import is_peft_available
from trl.trainer.reward_trainer import List
from trl.trainer.reward_trainer import nested_detach
from trl.trainer.reward_trainer import nn
from trl.trainer.reward_trainer import Optional
from trl.trainer.reward_trainer import PeftModel
from trl.trainer.reward_trainer import prepare_model_for_kbit_training
from trl.trainer.reward_trainer import PreTrainedModel
from trl.trainer.reward_trainer import PreTrainedTokenizerBase
from trl.trainer.reward_trainer import replace
...
from trl.trainer.reward_trainer import torch
from trl.trainer.reward_trainer import Trainer
from trl.trainer.reward_trainer import TrainerCallback
from trl.trainer.reward_trainer import TrainingArguments
from trl.trainer.reward_trainer import Tuple
from trl.trainer.reward_trainer import Union
from trl.trainer.reward_trainer import warnings
...
class _UnslothRewardTrainer(Trainer):
    ...
    def prediction_step(
        ...
        loss = loss.detach()
        logits = tuple(
            v for k, v in logits_dict.items()
