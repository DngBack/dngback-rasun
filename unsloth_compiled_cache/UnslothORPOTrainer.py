...
from trl.trainer.orpo_trainer import Any
from trl.trainer.orpo_trainer import AutoModelForCausalLM
from trl.trainer.orpo_trainer import Callable
from trl.trainer.orpo_trainer import DataCollator
from trl.trainer.orpo_trainer import DataLoader
from trl.trainer.orpo_trainer import Dataset
from trl.trainer.orpo_trainer import deepcopy
from trl.trainer.orpo_trainer import defaultdict
from trl.trainer.orpo_trainer import Dict
from trl.trainer.orpo_trainer import disable_dropout_in_model
from trl.trainer.orpo_trainer import DPODataCollatorWithPadding
from trl.trainer.orpo_trainer import EvalLoopOutput
from trl.trainer.orpo_trainer import F
from trl.trainer.orpo_trainer import inspect
from trl.trainer.orpo_trainer import is_peft_available
from trl.trainer.orpo_trainer import is_torch_fx_proxy
from trl.trainer.orpo_trainer import is_wandb_available
from trl.trainer.orpo_trainer import List
from trl.trainer.orpo_trainer import Literal
from trl.trainer.orpo_trainer import nn
from trl.trainer.orpo_trainer import np
from trl.trainer.orpo_trainer import nullcontext
from trl.trainer.orpo_trainer import Optional
from trl.trainer.orpo_trainer import ORPOConfig
from trl.trainer.orpo_trainer import ORPOTrainer
from trl.trainer.orpo_trainer import pad_to_length
from trl.trainer.orpo_trainer import PartialState
from trl.trainer.orpo_trainer import peft_module_casting_to_bf16
from trl.trainer.orpo_trainer import PeftModel
from trl.trainer.orpo_trainer import prepare_model_for_kbit_training
from trl.trainer.orpo_trainer import PreTrainedModel
from trl.trainer.orpo_trainer import PreTrainedModelWrapper
from trl.trainer.orpo_trainer import PreTrainedTokenizerBase
from trl.trainer.orpo_trainer import random
from trl.trainer.orpo_trainer import torch
from trl.trainer.orpo_trainer import Trainer
from trl.trainer.orpo_trainer import TrainerCallback
from trl.trainer.orpo_trainer import trl_sanitze_kwargs_for_tagging
from trl.trainer.orpo_trainer import Tuple
from trl.trainer.orpo_trainer import Union
from trl.trainer.orpo_trainer import wandb
from trl.trainer.orpo_trainer import warnings
from trl.trainer.orpo_trainer import wraps
...
class _UnslothORPOTrainer(Trainer):
    ...
    def __init__(
        ...
        if tokenizer is None:
            raise ValueError(
                'tokenizer must be specified to tokenize a ORPO dataset.',
            )
    ...
    def tokenize_row(self, feature, model: Optional[Union[PreTrainedModel, nn.Module]] = None) -> Dict:
        ...
        if not self.is_encoder_decoder:
            ...
            chosen_prompt_len_input_ids = len(
                chosen_tokens['prompt_input_ids'],
            )
            rejected_prompt_len_input_ids = len(
            ...
            longer_response_length = max(
                len(chosen_tokens['input_ids']), len(
    ...
    def evaluation_loop(
        ...
        if self.generate_during_eval:
            ...
            policy_output_decoded = self.get_batch_samples(
    ...
    def _shift_right(self, input_ids):
        ...
        shifted_input_ids.masked_fill_(
            shifted_input_ids == -100, self.pad_token_id,
        )
